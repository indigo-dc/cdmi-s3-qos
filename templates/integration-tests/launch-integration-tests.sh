...
curl -s -X GET http://restadmin:restadmin@localhost:8080/cdmi_capabilities/
...
curl -s -X GET http://restadmin:restadmin@localhost:8080/cdmi_capabilities/container

echo "Asking for profiles related with dataobjects"
curl -s -X GET http://restadmin:restadmin@localhost:8080/cdmi_capabilities/dataobject


## 6. Ask for QoS of above created containers
echo ""
echo "Asking for QoS capabilities of standard container"
curl -s -X GET http://restadmin:restadmin@localhost:8080/standard -H "Content-Type: application/cdmi-container"

echo ""
echo "Asking for QoS capabilities of silver container"
curl -s -X GET http://restadmin:restadmin@localhost:8080/silver -H "Content-Type: application/cdmi-container"

echo ""
echo "Asking for QoS capabilities of golden container"
curl -s -X GET http://restadmin:restadmin@localhost:8080/golden -H "Content-Type: application/cdmi-container"
...
curl -s -X GET http://restadmin:restadmin@localhost:8080/standard/file1.txt -H "Content-Type: application/cdmi-object"

echo ""
echo "Asking for QoS capabilities of silver/file2.txt dataobject"
curl -s -X GET http://restadmin:restadmin@localhost:8080/silver/file2.txt -H "Content-Type: application/cdmi-object"

echo ""
echo "Asking for QoS capabilities of golden/file3.txt dataobject"
curl -s -X GET http://restadmin:restadmin@localhost:8080/golden/file3.txt -H "Content-Type: application/cdmi-object"
